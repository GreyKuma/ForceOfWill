...
public class CardAttribute extends MultiLanguageString implements Entity, Serializable {
    ...
    private static int getDrawableIdByDe(String de) {
        switch (de) {
            case "Licht":
                return R.drawable.ic_card_attribute_light;
            case "Finsternis":
                return R.drawable.ic_card_attribute_shadow;
            case "Feuer":
                return R.drawable.ic_card_attribute_fire;
            case "Wasser":
                return R.drawable.ic_card_attribute_water;
            case "Wind":
                return R.drawable.ic_card_attribute_wind;
            default:
                return 0;
        }
    }
